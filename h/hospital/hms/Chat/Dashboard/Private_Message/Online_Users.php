...
echo "<span id='chat-logo'>"."Chat"."</span></br><hr>";
  ...
  while($row = mysqli_fetch_array($run)){
    $userID++;
    $newusername = $row["first_name"];
    $newuserslast_name = $row["last_name"];

    echo "<div>";

    echo "<ul>";

    $command_query = "SELECT * FROM users_table WHERE user_fname = '$newusername' AND user_lname='$newuserslast_name'";
    ...
    if($row["Profile_Picture"]==""){
        echo "<li class='users' id='$userID' name='$newusername' alt='$newuserslast_name'><img class='my_profile_image' src='../Profile_Pictures/default.png' height='35' width='35'/>&nbsp;&nbsp;"."<strong>".$newusername."</strong><span class='users_status_not_active'></span></li>";
    }else{
        $username_picture = $row["Profile_Picture"];
        echo "<li class='users' id='$userID' name='$newusername' alt='$newuserslast_name'><img class='my_profile_image' src='../Profile_Pictures/$username_picture' height='35' width='35'/>&nbsp;&nbsp;"."<strong>".$newusername."</strong><span class='users_status_not_active'></span></li>";
    }
  }
    echo "</ul>";
    echo "</div>";
