...
<a href="#" class="header_text"> <p id="header-text" class="text-muted">HEALTH MONITORING SYSTEM<span style="color:blue"> CHAT PAGE</span></p></a>
</span>
</div>
...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
           ...
           <li onclick="Logout()"><a href="http://localhost/zzzzz/h/hospital/index.html"><img src="../img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Logout</span></a></li>
        </ul>
    </div>
    ...
    <!-- Main Content Starts Here -->
      ...
      <div id="Main_Chat_Box" class="col-md-8">
        ...
        <div id="get_chatting_user_name">
          <div style="font-weight:bold;font-size:1.2em;float:left;color:rgba(69, 162, 255, 0.93)"> Public Group Chats </div>
...
if(!empty($get_profile["receiver_message"])){

    $messageReceiver = $_COOKIE["user_first_name"];
    $newmessage = mysqli_real_escape_string($connection_String, $_POST["receiver_message"]);

    $my_query = "Select * from public_messages";
