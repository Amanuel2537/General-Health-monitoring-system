...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <!-- <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="Private_Share.php"><img src="../img/remove-user.png" class="navimg img-responsive" /><span class="nav-writting">Public Share</span></a></li> -->
            ...
            <li onclick="Logout()"><a href="http://localhost/zzzzz/h/hospital/hms/doctor/dashboard.php""><img src="../img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Logout</span></a></li>
        </ul>
    </div>
