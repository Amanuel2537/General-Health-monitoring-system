...
if (isset($_POST['submit'])) {
	...
	$macnum =  $_POST['macnum'];
	$sql = mysqli_query($con, "insert into tblpatient(Docid,PatientName,PatientContno,PatientEmail,PatientGender,PatientAdd,PatientAge,PatientMedhis,PatientRoomNumber,PatientMac) values('$docid','$patname','$patcontact','$patemail','$gender','$pataddress','$patage','$medhis','$patroom','$macnum')");
	if ($sql) {
											...
											<div class="panel-body">
												<form role="form" name="" method="post">
													...
													<div class="form-group">
														...
														<input type="text" id="patroom" name="patroom" class="form-control" placeholder="Enter Patient Room Numbrer id" required="true" onBlur="userAvailability()">
														<span id="user-availability-status1" style="font-size:12px;"></span>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" id="macnum" name="macnum" class="form-control" placeholder="Enter Mac Number" required="true" onBlur="userAvailability()">
														<span id="user-availability-status1" style="font-size:12px;"></span>
													</div>
													<div class="form-group">
														<label class="block">
